...
| [0047](0047-per-track-instrument-slot.md) | One persisted instrument per Track, shared by every MIDI Clip on it (supersedes 0045's Instrument-by-Clip identity law in part) | Proposed |
