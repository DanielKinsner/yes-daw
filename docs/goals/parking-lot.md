...
- **Timeline GPU frame-budget benchmark is within noise of its threshold on the hosted runners (2026-09-02).** `timeline_gpu_tests.cpp:84` (`sustained < kFrameBudgetMs` 16.6 ms) went red on runs `33611885978` (macOS 17.06), `33626513605` (macOS 18.54) `33627456994` (Windows 16.88), `33633084596` (macOS), `33639686386` (macOS) and `33645105611` (macOS 17.79, G2.16) on commits that do not touch the canvas paint; the outlier allowance (8) does not cover a sustained value 0.3 ms over. Reruns pass. Owner: the render-budget item (G3 layered rendering) — measure the hosted runners' floor before pinning a budget they cannot hold; never weaken the gate without that number.
