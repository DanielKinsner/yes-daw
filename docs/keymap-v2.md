...
- Reverse (`timeline.clip.reverse`)
- Normalize (`timeline.clip.normalize`)
- Strip Silence (`timeline.clip.strip_silence`)
...
- Add Tempo Change at Playhead (`timeline.tempo.change_add`)
- Remove Tempo Change at Playhead (`timeline.tempo.change_remove`)
...
- Overlap (`edit.mode.overlap`)
- No Overlap (`edit.mode.no_overlap`)
- Shuffle (`edit.mode.shuffle`)
- Snap: Grid (`timeline.snap_mode.grid`)
- Snap: Relative (`timeline.snap_mode.relative`)
- Snap: Events (`timeline.snap_mode.events`)
- Snap: Off (`timeline.snap_mode.off`)
...
- Instrument Parameter (`track.instrument.param`)
