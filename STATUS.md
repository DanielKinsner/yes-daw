...
MainComponent meter-fill, shell panel-inset, and inspector-control spacing token migrations exist; broad
...
internal spacing that is not yet covered by the theme audit, before broad UI migration.
