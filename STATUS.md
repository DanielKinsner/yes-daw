...
so scratch raw `fillEllipse` and `PathStrokeType` expression geometry fails the audit.
...
point and curve-stroke geometry is also tokenized; broad UI migration is not complete.
