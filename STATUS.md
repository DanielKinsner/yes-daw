...
scratch raw `inspectorGain.setRange`/`setValue` defaults fail the audit.
...
gain-slider range/step/default are also tokenized; broad UI migration is not complete.
