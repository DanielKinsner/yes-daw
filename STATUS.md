...
tokenized; MainComponent painted header/transport/master-meter geometry is also tokenized; broad UI
...
audit, such as the painted piano-roll geometry or another raw painted panel surface, before broad UI
migration.
