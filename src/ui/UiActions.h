...
inline constexpr std::array<UiActionDescriptor, kUiActionCount> kUiActionDescriptors {{
    ...
    { UiActionId::TimelineToolSelectZoom, "timeline.tool.zoom", "Zoom", "6", "Select zoom tool",
      AccessibilityRole::Button, UiActionKind::Command, false, false, false, false },
    { UiActionId::TimelineToolSelectEraser, "timeline.tool.eraser", "Eraser", "4", "Select the eraser tool: click a note or clip to delete it",
      AccessibilityRole::Button, UiActionKind::Command, false, false, false, false },
    { UiActionId::TimelineToolSelectVelocity, "timeline.tool.velocity", "Velocity", "5", "Select the velocity tool: drag a note up or down to set its velocity",
      AccessibilityRole::Button, UiActionKind::Command, false, false, false, false },
